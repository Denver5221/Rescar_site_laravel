...
class PartenaireController extends Controller
{
    ...
    public function index()
    {
        try {
                ...
                return view('pages.rescar-aoc.partenaire', ['partenaires'=>$partenaires, 'title' => 'Partenaires - Rescar-Aoc | RESCAR-AOC -Dashboard ', 'breadcrumb' => 'This Breadcrumb']);
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            if ($request->hasFile('image') && $request->file('image')->isValid()) {
                ...
                $cheminDeDestination = public_path('storage/imagePartenaire') . '/' . $nomFichierAvecExtension;
                $photo->move(public_path('storage/imagePartenaire'), $nomFichierAvecExtension);
            ...
            $partner->image = 'imagePartenaire/'.$nomFichierAvecExtension;
            ...
            $activity->title = 'Un partenaire été ajouté: '.$partner->nom;
    ...
    public function update(Request $request, $id)
    {
        try {
            ...
            $partner->save();
                // Traiter l'image si elle est présente
                    ...
                    /////////////////////////////// historique
            $activity = new Activity();
            $activity->title = 'Un Patenaire été Modifier: '.$partner->nom;
            $activity->type = 't-danger';
            $activity->icon = 'feather-plus';
            $activity->id_user = auth()->user()->id; // Associer l'ID de l'utilisateur actuel à l'activité
            $activity->save();
     ...
     //////////////////////// changer de staut
     public function updateStatus(Request $request, $partenaireId)
     {

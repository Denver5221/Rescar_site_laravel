...
<header class="page-header" data-background="{{ asset('front/images/page-header-bg.jpg') }}" data-stellar-background-ratio="0.7">
  <div class="container">
  <h2>Organismes </h2>
    <p>Decouvrez les Organisations spécialisées dans le développement </p>
  </div>
  <!-- end container -->
        ...
        <div class="swiper-slid">
          <figure>
            ...
            <h5>{{ $data->nom }}</h5>
              ...
              <ul>
                  @if ($data->site) <li><a href="{{ $data->site }}"><i class="lni lni-link"></i> : <strong>{{ $data->site }}</strong> </a></li> @endif
                  <li><a href="{{ $data->numero }}"><i class="lni lni-phone"></i> : <strong> +226 {{ $data->numero }} </strong></a></li>
                </ul>
            </figcaption>
            </figure>
        </div>

      ...
      <div class="col-lg-6">
          ...
          <div class=" col-12 d-flex flex-column self-center mx-auto">
            <div class="card mt-3 mb-3">
                <div class="card-body">
                  <form action="{{ route('qui-somme-nous.membreMorale_post') }}" method="post" enctype="multipart/form-data">
                        @csrf
                    <div class="row">
                        ...
                        <div class="col-md-12">
                          <div class="mb-3">
                              <label for="pays">Pays siège :</label>
                        ...
                        <div class="col-md-12">
                          <div class="mb-3">
                              <label for="pays">Structure légalisée :</label>
                                <select id="sexe" name="légalisée">
                                  <option>Oui</option>
                                  <option>Non</option>
                                </select>
                                <br>
                        ...
                        <div class="col-md-12">
                            <div class="mb-3">
                                <label class="form-label">Nombre du perrsonnel</label>
                                <input type="number" name="nombre" required class="form-control">
                            </div>
                        </div>

                        <div class="col-md-12">
                            <div class="mb-3">
                                <label class="form-label">Nom de la personne de contact</label>
                        ...
                        <div class="col-md-12">
                            <div class="mb-3">
                                <label class="form-label">Prénom de la personne de contact </label>
                        ...
                        <div class="col-md-12">
                            <div class="mb-3">
                                <label class="form-label">Fonction de la personne de contact </label>
                                <input type="text" name="fonction_contact" required class="form-control">
                            </div>
                        </div>

                        <div class="col-md-12">
                            <div class="mb-3">
                                <label class="form-label">Numéro de la personne de contact</label>
                                <input type="text" name="phone_contact" required class="form-control">
                            </div>
                        </div>
                        ...
                        <div class=" col-12">
                            <div class="mb-3">
                                <div class="form-check form-check-primary form-check-inline">
                                    <input class="form-check-input me-3" type="checkbox" required name="terme" id="form-check-default">

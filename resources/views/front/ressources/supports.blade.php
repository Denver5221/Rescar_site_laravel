    ...
    <div class="row">
      ...
      <figure><img src="{{ asset('storage/'.$item->image) }}" alt="Image"></figure>
        ...
        <h3>{{ substr($item->titre, 0, 50) }}...</h3>
          ...
          <button class="btn btn-success  mb-2 me-4 btn-sm"><b><a href="{{ url('ressources/support-formation/'.$item->slug) }}">En savoir plus</a></b></button>
        </div>
        <!-- end content -->
      </div>
      <!-- end side-image-box -->
      ...
      <div class="widget">
        ...
        <form method="POST" action="{{ route('ressources.support-formation.search') }}">
            @csrf

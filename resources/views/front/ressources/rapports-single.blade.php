      ...
      <div class="modal-dialog" role="document">
          <div class="modal-content">
              ...
              <div class="modal-body">
                  <form action="{{ route('ressources.rapport-activités.commentaire') }}" method="POST">
                      @csrf
  ...
  @endif
        ...
        <div class="blog-post">
            <div class="col-lg-12">
              ...
              <form method="post" action="{{ route('ressources.rapport-activités.commentaire') }}">
                  @csrf
      ...
      <div class="widget">
        ...
        <form method="POST" action="{{ route('ressources.rapport-activités.search') }}">
            @csrf
        ...
        <ul class="categories">
            ...
            <li><a href="{{ url('ressources/rapport-activités/recherche_par_category/'.$category->id) }}">{{ $category->nom }}</a></li>

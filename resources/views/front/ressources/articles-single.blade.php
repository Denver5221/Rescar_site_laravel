      ...
      <div class="modal-dialog" role="document">
          <div class="modal-content">
              ...
              <div class="modal-body">
                  <form action="{{ route('ressources.articles-mémoires-recherche.commentaire') }}" method="POST">
                      @csrf
  ...
  @endif
        ...
        <div class="blog-post">
            <div class="col-lg-12">
              ...
              <form method="post" action="{{ route('ressources.articles-mémoires-recherche.commentaire') }}">
                  @csrf

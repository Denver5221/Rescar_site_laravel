    ...
    <x-slot:headerFiles>
        ...
        <div class="page-meta">
            <nav class="breadcrumb-style-one" aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="#">Repertoire</a></li>
        ...
        <div class="row layout-top-spacing" id="cancel-row">
            ...
            <div class=" widget-content seperator-header text-center">
                <button class="btn btn-success mb-2 me-8 btn-lg" data-bs-toggle="modal" data-bs-target="#inputFormModal" >Ajouter un organisme</button>
            </div>
        ...
        <div class="modal fade inputForm-modal" id="inputFormModal" tabindex="-1" role="dialog" aria-labelledby="inputFormModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                ...
                <div class="modal-header" id="inputFormModalLabel">
                    <h5 class="modal-title">Ajouter un <b>organisme</b></h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-hidden="true"><svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-x"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg></button>
                </div>
                <div class="modal-body">
                    <form class="mt-0" method="POST" action="{{ route('organismes.store') }}" enctype="multipart/form-data" data-store-url="{{ route('partenaire.store') }}">
                        @csrf
                        ...
                        <div class="form-group">
                            <div class="input-group mb-3">
                                ...
                                <input type="text" name="nom" required class="form-control" placeholder="Nom de l'organisme" aria-label="text">
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="input-group mb-3">
                                ...
                                <textarea name="description" required class="form-control" id="exampleFormControlTextarea1" placeholder="Description du l'organisme" rows="3"></textarea>
                    ...
                    <script>
                        document.querySelector('.widget-content.icon-success').addEventListener('click', function() {
                            Swal.fire({
                                icon: 'success',
                                title: 'Organisme ajouter avec succès',
                            });
                        });
                    </script> --}}
                </div>
                               ...
                               @endphp
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <span><img width="50px" src="{{ asset('storage/'.$data->image) }}" class="profile-img" alt="avatar"></span>
                                    </td>
                                    <td>{{ $data->site }}</td>
                                    ...
                                    <td class="text-center">
                                        <button class="{{ $statusClass }} status-button" data-status-url="{{ route('organismes.updateStatus', $data->id) }}" data-current-status="{{ $data->status ? 'active' : 'inactive' }}">{{ $statusText }}</button>
                                    </td>
                                    <td class="text-center">
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuLink1">
                                                <a class="dropdown-item" href="{{ url('repertoires/organismes') }}">Voir</a>
                                                <a class="dropdown-item" data-bs-toggle="modal" data-bs-target="#inputFormModal{{ $data->id }}" href="javascript:void(0);">Modifier</a>

                                                <button class="delete-button dropdown-item widget-content warning confirm" data-delete-url="{{ route('organismes.delete', $data->id) }}">Supprimer</button>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
        ...
        <div class="modal fade" id="inputFormModal{{ $data->id }}" tabindex="-1" aria-labelledby="inputFormModal{{ $data->id }}Label" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                ...
                <div class="modal-body">
                    <form class="mt-0" action="{{ route('organismes.update', $data->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="input-group mb-3">
                                <div class="col-md-6 mx-auto">
                                    ...
                                    <div class="profile-image">
                                        ...
                                        <div class="">
                                            <img width="50" src="{{ asset('storage/' . $data->image) }}"  alt="">
                        ...
                        <div class="form-group">
                            <div class="input-group mb-3">
                                ...
                                <input type="text" required name="nom" value="{{ $data->nom }}" class="form-control" placeholder="Nom de l'organisme" aria-label="text">
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="input-group mb-3">
                                ...
                                <textarea class="form-control" name="description" required id="exampleFormControlTextarea1" placeholder="Description de l'organisme" rows="3">{{ $data->description }}</textarea>
                        ...
                        <div class="form-group">
                            <div class="input-group mb-3">
                                ...
                                <input type="text" name="site" value="{{ $data->site }}" class="form-control" placeholder="site web" aria-label="text">
                        ...
                        <div class="form-group">
                            <div class="input-group mb-3">
                                ...
                                <input type="text" value="{{ $data->numero }}" required name="numero" class="form-control" placeholder="Numero" aria-label="text">

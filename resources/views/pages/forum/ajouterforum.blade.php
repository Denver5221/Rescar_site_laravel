<x-base-layout :scrollspy="false">
    ...
    <x-slot:headerFiles>
       ...
       <script>
        ...
        @endif
        <!-- /BREADCRUMB -->
        <form id="form" class="mt-0" method="POST" action="{{ route('forum.store') }}" enctype="multipart/form-data">
            ...
            <div class="row mb-4 layout-spacing layout-top-spacing">
                ...
                <div class="col-xxl-9 col-xl-12 col-lg-12 col-md-12 col-sm-12">
                    ...
                    <div class="widget-content widget-content-area blog-create-section">
                        ...
                        <div class="row mb-4">
                            <div class="col-sm-12">
                                <input type="text" name="thematique" required class="form-control" id="Post-Title" placeholder="Titre">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="input-group mb-3">
                                ...
                                <textarea name="description" class="form-control" id="exampleFormControlTextarea1" placeholder="Description est facultatif" rows="10"></textarea>
                    ...
                    <div class="widget-content widget-content-area blog-create-section">
                        <div class="row">
                            ...
                            <div class="col-xxl-12 col-md-12 mb-4">
                                ...
                                <input id="tags" name="tags[]" required class="blog-tags" value="">
                            </div>

<x-base-layout :scrollspy="false">
    ...
    <div class="row layout-top-spacing" id="cancel-row">
        ...
        <div class=" widget-content seperator-header text-center">
            ...
            <a href="{{getRouterValue();}}/actualites/categorie"><button class="btn btn-success mb-2 me-8 btn-lg">Categorie</button></a>
                    ...
                    <table id="style-3" class="table style-3 dt-table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $forum->user->email }} </td>
                                <td> {{ substr($forum->thematique->thematique, 0, 25) }}</td>
                                <td class="text-center">{{ $forum->created_at->format('d/m/Y') }}</td>
                                @php
                                $status =$forum->thematique->status;
                                ...
                                <td class="text-center">
                                    <button class="{{ $statusClass }} status-button" data-status-url="{{ route('forum.status', $forum->thematique->id) }}" data-current-status="{{ $forum->thematique->status ? 'active' : 'inactive' }}">{{ $statusText }}</button>
                                </td>
                                {{--  <td class="text-center"><span class="shadow-none badge badge-success">Actif</span></td>  --}}
                                <td class="text-center">
                                    <div>
                                        <a href="{{ url('/forum/detail/'.$forum->slug) }}"><button class="btn btn-danger btn-sm _effect--ripple waves-effect waves-light">Voir</button></a>
                                    </div>
                                </td>
                            </tr>
                            @endforeach
                ...
                <div class="widget-content widget-content-area">
                    ...
                    <table id="style-4" class="table style-3 dt-table-hover">
                        ...
                        <tbody>
                            ...
                            @if($forum->id_user !== null)

                            @if($forum->id_user == auth()->user()->id)
                                <!-- Code à exécuter si les ID correspondent -->
                                ...
                                <td class="text-center">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuLink1">
                                            <a class="dropdown-item" href="{{ url('/forum/detail/'.$forum->slug) }}">Voir</a>
                                            <a class="dropdown-item" href="{{ url(getRouterValue().'/forum/edite/' .$forum->slug) }}"  >Modifier</a>
                                            <button class="delete-button dropdown-item widget-content warning confirm" data-delete-url="{{ route('forum.delete', $forum->thematique->id) }}">Supprimer</button>
                                        </div>
                                    </div>
                                </td>
                            </tr>
                            @elseif(auth()->check() && (auth()->user()->roles()->where('nom', 'Administrateur')->exists()))
                            <tr>
                                <td class="checkbox-column text-center"> {{ $num++ }} </td>
                                <td>{{ substr( $forum->thematique->thematique, 0,25) }} </td>
                                <td class="text-center">{{ $forum->created_at->format('d/m/Y') }}</td>

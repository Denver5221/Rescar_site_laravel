<x-base-layout :scrollspy="false">
    ...
    <x-slot:headerFiles>
       ...
       <script>
        ...
        @endif
        <form id="form"  class="mt-0" action="{{ route('forum.update', $forum->thematique->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <div class="row mb-4 layout-spacing layout-top-spacing">
                ...
                <div class="col-xxl-9 col-xl-12 col-lg-12 col-md-12 col-sm-12">
                    ...
                    <div class="widget-content widget-content-area blog-create-section">
                        ...
                        <div class="row mb-4">
                            <div class="col-sm-12">
                                <input type="text" name="thematique" required class="form-control" id="Post-Title" placeholder="Titre" value="{{ $forum->thematique->thematique }}" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="input-group mb-3">
                                ...
                                <textarea class="form-control" id="exampleFormControlTextarea1" name="description" placeholder="Ajouter une Description" rows="10" >{{ $forum->thematique->description }}</textarea>
                        ...
                        <div class="row">
                            <div class="col-xxl-12 mb-4">
                                <div class="switch form-switch-custom switch-inline form-switch-primary">
                                    ...
                                    {{ $forum->thematique->status ? 'checked' : '' }}>
                            ...
                            <div class="col-xxl-12 mb-4">
                                <div class="switch form-switch-custom switch-inline form-switch-primary">
                                    ...
                                    {{ $forum->thematique->active_commentaire ? 'checked' : '' }}>
                                    <label class="switch-label" for="enableComment">Activer les comments</label>
                                </div>
                            </div>
                            <div class="col-xxl-12 col-md-12 mb-4">
                                <label for="tags">Tags</label>
                                <input id="tags" required class="blog-tags" name="tags[]"  value="{{ implode(', ', array_column($tags, 'value')) }}">
                            </div>

                            <div class="col-xxl-12 col-md-12 mb-4">
                                <label for="category">Categories</label>
                                <input id="category" required name="category[]" value="{{ $forum->categories->pluck('nom')->implode(',') }}">
                            </div>
                            ...
                            <div class="col-xxl-12 col-sm-4 col-12 mx-auto">
                                ...
                                <button class="btn btn-success w-100">Modifier actualité</button>
                            </div>

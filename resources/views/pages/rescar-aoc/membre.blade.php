<x-base-layout :scrollspy="false">
    ...
    <div class="row layout-top-spacing" id="cancel-row">
        ...
        <div class=" widget-content seperator-header text-center">
            <button class="btn btn-success mb-2 me-8 btn-lg" data-bs-toggle="modal" data-bs-target="#inputFormModal" >Ajouter un membre</button>
            <a href="{{getRouterValue();}}/rescar-oac/partenaire/poste"><button class="btn btn-success mb-2 me-8 btn-lg">Poste</button></a>
        </div>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
          <div class="modal-content">
            ...
            <div class="modal-header" id="inputFormModalLabel">
                <h5 class="modal-title">Ajouter un <b>membre</b></h5>
           ...
           <script>
            ...
            @endif
                <form class="mt-0" method="POST" action="{{ route('membre.store') }}" enctype="multipart/form-data" data-store-url="{{ route('partenaire.store') }}">
                    @csrf
                                ...
                                <div class="profile-image">
                                    ...
                                    <div class="">
                                        <input type="file" class=""
                                            name="photo"  accept="image/png, image/jpeg, image/gif"/>
                                    </div>
                    ...
                    <div class="form-group">
                        <div class="input-group mb-3">
                            ...
                            <input type="text" required name="nom"  class="form-control" placeholder="Nom du membre" aria-label="text">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="input-group mb-3">
                            ...
                            <input type="text" name="prenom" required class="form-control" placeholder="Prenom du membre" aria-label="text">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="input-group mb-3 ">
                            <span class="input-group-text">
                                ...
                                <select name="id_post" required class="form-select form-select">
                    ...
                    <div class="form-group">
                        <div class="input-group mb-3">
                            ...
                            <input type="mail" required name="email" class="form-control" placeholder="Email" aria-label="text">
                    ...
                    <div class="form-group">
                        <div class="input-group mb-3">
                            ...
                            <input type="text" required name="telephone" class="form-control" placeholder="Numero" aria-label="text">
                    ...
                    <div class="form-group">
                        <label for="product-images"> CV </label>
                ...
                <div class="row">
                    <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                        <h4>Desole!!! Ajoutez un postes</h4>
                    </div>
                </div>
                <div class=" widget-content seperator-header text-center">
                    <button class="btn btn-success mb-2 me-8 btn-lg" data-bs-toggle="modal" data-bs-target="#inputFormModal" >Ajouter un membre</button>
                ...
                <script>
                    document.querySelector('.widget-content.icon-success').addEventListener('click', function() {
                        Swal.fire({
                            icon: 'success',
                            title: 'Membre ajouter avec succès',
                        });
                    });
                </script>  --}}
          </div>
                    ...
                    <table id="style-3" class="table style-3 dt-table-hover">
                        <thead>
                            <tr>
                                ...
                                <th >Poste</th>
                                <th >Contact </th>
                                <th class="checkbox-column text-center">CV</th>
                                <th class="">Status</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                   @if($membre->photo) <span><img width="50" src="{{ asset($membre->photo) }}" class="profile-img" alt="avatar"></span> @else <p>Pas d'image</p> @endif
                                </td>
                                <td>{{ $membre->post_nom }}</td>
                                <td>{{ $membre->telephone }}</td>
                                <td class="text-center">
                                    @if($membre->cv)
                                    <a class="dropdown-toggle" href="{{ asset($membre->cv)}}" target="_blank">
                                ...
                                <td class="text-center">
                                    <button class="{{ $statusClass }} status-button" data-status-url="{{ route('membre.status', $membre->id) }}" data-current-status="{{ $membre->status ? 'active' : 'inactive' }}">{{ $statusText }}</button>
                                </td>
                                <td class="text-center">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuLink1">
                                            <a class="dropdown-item" href="{{ url('qui-somme-nous/membres') }}">Voir</a>
                                            <a class="dropdown-item" data-bs-toggle="modal" data-bs-target="#inputFormModal{{ $membre->id }}" href="javascript:void(0);">Modifier</a>

                                            {{--  <a class="dropdown-item" data-bs-target="#inputFormModal{{ $membre->id }}" href="javascript:void(0);">Modifier</a>  --}}
                                            <button class="delete-button dropdown-item widget-content warning confirm" data-delete-url="{{ route('membre.delete', $membre->id) }}">Supprimer</button>

                                            {{--  <a class="dropdown-item widget-content warning confirm" data-delete-url="{{ route('membre.delete', $poste->id) }}">Supprimer</a>  --}}
                                        </div>
                                    </div>
                                </td>
                            </tr>

                            <div class="modal fade" id="inputFormModal{{ $membre->id }}" tabindex="-1" aria-labelledby="inputFormModal{{ $membre->id }}Label" aria-hidden="true">
                                    ...
                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                      <div class="modal-content">
                                        ...
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="inputFormModal{{ $membre->id }}Label">Modifier le membre</h5>
                                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                        </div>
                                        <div class="modal-body">
                                                <form class="mt-0" action="{{ route('membre.update', $membre->id) }}" method="POST" enctype="multipart/form-data">
                                                    @csrf
                                                    @method('PUT')
                                                            ...
                                                            <div class="input-group mb-3">
                                                                <div class="col-md-6 mx-auto">
                                                                    ...
                                                                    <div class="profile-image">
                                                                        ...
                                                                        <div class="">
                                                                            <img width="100" src="{{ asset('storage/' . $membre->photo) }}"  alt="">
                                                                            <input type="file" class="" name="photo" accept="image/png, image/jpeg, image/gif"/>
                                                                        </div>

                                                                        @if ($membre->photo)
                                                                            <p>Fichier actuel : {{ $membre->photo }}</p>
                                                                        @else
                                                        ...
                                                        <div class="form-group">
                                                            <div class="input-group mb-3">
                                                                ...
                                                                <input type="text" name="nom" value="{{ $membre->nom }}" required class="form-control" placeholder="Nom du membre" aria-label="text">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            <div class="input-group mb-3">
                                                                ...
                                                                <input type="text" name="prenom" value="{{ $membre->prenom }}" required  class="form-control" placeholder="Prenom du membre" aria-label="text">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            <div class="input-group mb-3 ">
                                                                ...
                                                                <select name="id_post" required class="form-select form-select">
                                                                    @foreach($postes as $poste)
                                                                        <option value="{{ $poste->id }}" {{ $poste->id == $membre->id_post ? 'selected' : '' }}>
                                                                            {{ $poste->nom }}
                                                                        </option>
                                                                    @endforeach
                                                                </select>
                                                        ...
                                                        <div class="form-group">
                                                            <div class="input-group mb-3">
                                                                ...
                                                                <input type="mail" name="email" value="{{ $membre->email }}"   class="form-control" placeholder="Email" required aria-label="text">
                                                        ...
                                                        <div class="form-group">
                                                            <div class="input-group mb-3">
                                                                ...
                                                                <input type="text" name="telephone" value="{{ $membre->telephone }}"  required class="form-control" placeholder="Numero" aria-label="text">
                                                        ...
                                                        <div class="form-group">
                                                            <div class="input-group mb-3">
                                                                ...
                                                                <input type="text" name="facebook" value="{{ $membre->facebook }}"  class="form-control" placeholder="Lien Facebook (facultatif)" aria-label="text">
                                                        ...
                                                        <div class="form-group">
                                                            <div class="input-group mb-3">
                                                                ...
                                                                <input type="text" name="linkedin" value="{{ $membre->linkedin }}"  class="form-control" placeholder="Lien LinkedIn (facultatif)" aria-label="text">
                                                        ...
                                                        <div class="form-group">
                                                            <label for="product-images"> CV </label>
                                                            <div class="multiple-file-upload">
                                                                <input type="file" value="{{ $membre->cv }}"
                                                                name="cv">
                                                                {{--  @if ($membre->cv)
                                                                <p>Fichier actuel : {{ $membre->cv }}</p>
                                                                @else
                                                                    <p>Aucun fichier sélectionné</p>
                                                                @endif  --}}
                                                                <p>Fichier actuel : </p>
                                                                    <a class="dropdown-toggle" href="{{ asset('storage/' . $membre->cv)}}" target="_blank">
                                                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-file-minus"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline><line x1="9" y1="15" x2="15" y2="15"></line>
                                                                            </svg>
                                                                    </a>
                                                            </div>

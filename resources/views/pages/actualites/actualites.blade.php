<x-base-layout :scrollspy="false">
    ...
    <div class="row layout-top-spacing" id="cancel-row">
        ...
        <div class=" widget-content seperator-header text-center">
           <a href="{{getRouterValue();}}/actualites/ajouter"> <button class="btn btn-success mb-2 me-8 btn-lg" >Ajouter une actualité</button></a>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <span><img width="50" src="{{ asset('storage/' . $actualite->image)}}" class="profile-img" alt="avatar"></span>
                                </td>

                                <td>{{ substr($actualite->titre, 0, 25) }} </td>
                                ...
                                <td class="text-center">
                                    <button class="{{ $statusClass }} status-button" data-status-url="{{ route('actualites.status', $actualite->id) }}" data-current-status="{{ $actualite->status ? 'active' : 'inactive' }}">{{ $statusText }}</button>
                                </td>
                                ...
                                <td class="text-center">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuLink1">
                                            <a class="dropdown-item" href="{{ url('actualite/'.$actualite->slug) }}">Voir</a>
                                            <a class="dropdown-item" href="{{ url(getRouterValue().'/actualites/modifier/' .$actualite->slug) }}"  >Modifier</a>
                                            <button class="delete-button dropdown-item widget-content warning confirm" data-delete-url="{{ route('actualites.delete', $actualite->id) }}">Supprimer</button>

        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
          <div class="modal-content">
           ...
           <script>
            ...
            @endif
                <form class="mt-0" method="POST" action="{{ route('categories.store') }}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="text" name="nom"  class="form-control" placeholder="Nom de la categorie" aria-label="text">
                        </div>
                    </div>
                ...
                <div class="widget-content widget-content-area">
                    ...
                    <table id="style-3" class="table style-3 dt-table-hover">
                        ...
                        <tbody>
                                ...
                                <td class="text-center">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuLink1">
                                            ...
                                            <a class="dropdown-item" data-bs-toggle="modal" data-bs-target="#inputFormModal{{ $categorie->id }}" href="javascript:void(0);">Modifier</a>

                                            <button class="delete-button dropdown-item widget-content warning confirm" data-delete-url="{{ route('categories.delete', $categorie->id) }}">Supprimer</button>
                            ...
                            <div class="modal fade " id="inputFormModal{{ $categorie->id }}" tabindex="-1" role="dialog" aria-labelledby="inputFormModal{{ $categorie->id }}Label" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                  <div class="modal-content">

                                    <div class="modal-header" id="inputFormModal{{ $categorie->id }}Label">
                                        <h5 class="modal-title">Modifier une <b>categorie</b></h5>
                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-hidden="true"><svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-x"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg></button>
                                    </div>
                                    <div class="modal-body">
                                        <form class="mt-0" action="{{ route('categories.update', $categorie->id) }}" method="POST">
                                            @csrf
                                            @method('PUT')
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group mb-3">
                                                    ...
                                                    <input type="text" name="nom" value="{{ $categorie->nom }}" required class="form-control" placeholder="Nom de la categorie" aria-label="text">
                                                </div>
                                            </div>
                                            <div class="modal-footer">
                                                <button type="submit" class="btn btn-light-danger mt-2 mb-2 btn-no-effect" data-bs-dismiss="modal">Annuler</button>

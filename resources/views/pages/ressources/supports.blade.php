<x-base-layout :scrollspy="false">
    ...
    <div class="page-meta">
        <nav class="breadcrumb-style-one" aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="">Support de formation</a></li>
            </ol>
        </nav>
    </div>
    ...
    <div class="row layout-top-spacing" id="cancel-row">
        ...
        <div class=" widget-content seperator-header text-center">
           <a href="{{getRouterValue();}}/ressources/supports/ajouter"> <button class="btn btn-success mb-2 me-8 btn-lg" >Ajouter un support</button></a>
        </div>
            ...
            <div class="statbox widget box box-shadow">
                <div class="widget-content widget-content-area">
                    <center><br>
                        <div class="row">
                            <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                <h4>Liste des Supports de formation</h4>
                            </div>
                        </div>
                    </center>
                    <table id="style-3" class="table style-3 dt-table-hover">
                        ...
                        <tbody>
                            @if($supportformation->isNotEmpty())
                            @php
                                $num = 1;
                            @endphp
                                @foreach($supportformation as $support)

                        <tr>
                            <td class="checkbox-column text-center"> {{ $num++ }} </td>
                            <td class="text-center">
                                <a class="dropdown-toggle" href="{{ asset('storage/' . $support->image)}}" target="_blank">
                            ...
                            <td>{{ strtoupper(substr($support->titre, 0, 20)) }}</td>
                            ...
                            <td class="text-center">
                                <button class="{{ $statusClass }} status-button" data-status-url="{{ route('supports.updateStatus', $support->id)  }}" data-current-status="{{ $support->status ? 'active' : 'inactive' }}">{{ $statusText }}</button>
                            </td>
                             <td class="text-center">
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuLink1">
                                        <a class="dropdown-item" href="{{ url('ressources/support-formation/'.$support->slug) }}">Voir</a>
                                        <a class="dropdown-item" href="{{ url(getRouterValue().'/ressources/supports/modifier/' .$support->slug) }}"  >Modifier</a>
                                        <button class="delete-button dropdown-item widget-content warning confirm" data-delete-url="{{ route('supports.delete', $support->id) }}">Supprimer</button>
                                    </div>
                                </div>
                            </td>
                        </tr>

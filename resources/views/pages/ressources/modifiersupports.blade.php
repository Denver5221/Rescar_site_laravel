<x-base-layout :scrollspy="false">
    ...
    <x-slot:headerFiles>
        ...
        <div class="page-meta">
            <nav class="breadcrumb-style-one" aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{getRouterValue();}}/ressources/supports">Support de formation</a></li>
       ...
       <script>
        ...
        @endif
        <form id="form"  class="mt-0" action="{{ route('supports.update', $support->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <div class="row mb-4 layout-spacing layout-top-spacing">
                ...
                <div class="col-xxl-9 col-xl-12 col-lg-12 col-md-12 col-sm-12">
                    ...
                    <div class="widget-content widget-content-area blog-create-section">
                        ...
                        <div class="row mb-4">
                            <div class="col-sm-12">
                                <input type="text"  name="titre" value="{{ $support->titre }}" required class="form-control" id="Post-Title" placeholder="Titre">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="input-group mb-3">
                                ...
                                <textarea name="description"  required class="form-control" id="exampleFormControlTextarea1" placeholder="Description" rows="10"> {{ $support->description }}</textarea>
                    ...
                    <div class="widget-content widget-content-area blog-create-section mt-4">
                        ...
                        <div class="row mb-4">
                            <div class="col-xxl-12 mb-4">
                                <input type="text" name="meta_title" value="{{ $support->meta_title }}" required class="form-control" id="post-meta-title" placeholder="Meta Title">
                            </div>
                            <div class="col-xxl-12">
                                <label for="post-meta-description">Meta Description</label>
                                <textarea name="meta_description"  required class="form-control" id="post-meta-description" cols="10" rows="5">{{ $support->meta_description }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xxl-12 mb-4">
                                <div class="switch form-switch-custom switch-inline form-switch-primary">
                                    ...
                                    {{ $support->active_commentaire ? 'checked' : '' }}>
                            ...
                            <div class="col-xxl-12 col-md-12 mb-4">
                                ...
                                <input id="category" name="category[]" value="{{ $support->categories->pluck('nom')->implode(',') }}" placeholder="Choisissez...">
                            </div>
                            ...
                            <div class="col-xxl-12 col-md-12 mb-4">
                                ...
                                <img width="100px" src="{{ asset('storage/'.$support->image) }}" alt="">
                            ...
                            <div class="col-xxl-12 col-md-12 mb-4">
                                ...
                                @if ($support->file_fr)
                                <a href="{{ asset('storage/'.$support->file_fr) }}" download> Télécharger le fichier</a>
                                @endif
                            </div>
                            ...
                            <div class="col-xxl-12 col-md-12 mb-4">
                                ...
                                @if ($support->file_an)
                                <a href="{{ asset('storage/'.$support->file_an) }}" download> Télécharger le fichier</a>
                                @endif
                            </div>
                            ...
                            <div class="col-xxl-12 col-md-12 mb-4">
                                ...
                                @if ($support->file_pr)
                                <a href="{{ asset('storage/'.$support->file_pr) }}" download> Télécharger le fichier</a>
                                @endif
                            </div>

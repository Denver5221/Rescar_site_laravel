<x-base-layout :scrollspy="false">
    ...
    <x-slot:headerFiles>
       ...
       <script>
        ...
        @endif
        <form id="form" class="mt-0" method="POST" action="{{ route('fiches.store') }}" enctype="multipart/form-data">
            ...
            <div class="row mb-4 layout-spacing layout-top-spacing">
                ...
                <div class="col-xxl-9 col-xl-12 col-lg-12 col-md-12 col-sm-12">
                    ...
                    <div class="widget-content widget-content-area blog-create-section">
                        ...
                        <div class="row mb-4">
                            <div class="col-sm-12">
                                <input  type="number" name="numero" required class="form-control" id="Post-Title" placeholder="Numero">
                            </div>
                        </div>

<x-base-layout :scrollspy="false">
    ...
    <x-slot:headerFiles>
       ...
       <script>
        ...
        @endif
        <form id="form" class="mt-0" method="POST" action="{{ route('travail.store') }}" enctype="multipart/form-data">
            ...
            <div class="row mb-4 layout-spacing layout-top-spacing">
                ...
                <div class="col-xxl-9 col-xl-12 col-lg-12 col-md-12 col-sm-12">
                    ...
                    <div class="widget-content widget-content-area blog-create-section">
                        ...
                        <div class="row mb-4">
                            <div class="col-sm-12">
                                <input type="text" name="titre" required class="form-control" id="Post-Title" placeholder="Nom">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="input-group mb-3">
                                ...
                                <textarea name="description" required class="form-control" id="exampleFormControlTextarea1" placeholder="Thematique" rows="10"></textarea>
                    ...
                    <div class="widget-content widget-content-area blog-create-section">
                        <div class="row">
                            ...
                            <div class="col-xxl-12 col-md-12 mb-4">
                                <label for="tags">Entreprise</label>
                                <input id="tags" required name="tags[]" class="blog-tags" value="">
                            </div>

                            {{-- <div class="col-xxl-12 col-md-12 mb-4">
                                <label for="category">Categories</label>
                                <input id="category" required name="category[]" placeholder="Choisissez...">
                            </div> --}}

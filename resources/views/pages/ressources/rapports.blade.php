<x-base-layout :scrollspy="false">
    ...
    <div class="page-meta">
        <nav class="breadcrumb-style-one" aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="">Rapport d'activités</a></li>
            </ol>
        </nav>
    </div>
    ...
    <div class="row layout-top-spacing" id="cancel-row">
        ...
        <div class=" widget-content seperator-header text-center">
           <a href="{{getRouterValue();}}/ressources/rapports/ajouter"> <button class="btn btn-success mb-2 me-8 btn-lg" >Ajouter un rapport</button></a>
        </div>
                    ...
                    <center><br>
                        <div class="row">
                            <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                <h4>Liste des rapports d'activités</h4>
                            </div>
                        </div>
                    </center>
                    <table id="style-3" class="table style-3 dt-table-hover">
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <span><img width="50" src="{{ asset('storage/' . $rapport->image)}}" class="profile-img" alt="avatar"></span>
                            </td>
                            <td>{{ $rapport->numero }}</td>
                            <td>{{ strtoupper(substr($rapport->titre, 0, 20)) }}</td>
                            ...
                            <td class="text-center">
                                <button class="{{ $statusClass }} status-button" data-status-url="{{ route('rapports.updateStatus', $rapport->id)  }}" data-current-status="{{ $rapport->status ? 'active' : 'inactive' }}">{{ $statusText }}</button>
                            </td>
                             <td class="text-center">
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuLink1">
                                        <a class="dropdown-item" href="{{ url('ressources/rapport-activités/'.$item->slug) }}">Voir</a>
                                        <a class="dropdown-item" href="{{ url(getRouterValue().'/ressources/rapports/modifier/' .$rapport->slug) }}"  >Modifier</a>
                                        <button class="delete-button dropdown-item widget-content warning confirm" data-delete-url="{{ route('rapports.delete', $rapport->id) }}">Supprimer</button>
                                    </div>
                                </div>
                            </td>
                        </tr>

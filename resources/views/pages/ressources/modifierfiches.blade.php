<x-base-layout :scrollspy="false">
    ...
    <x-slot:headerFiles>
        ...
        <div class="page-meta">
            <nav class="breadcrumb-style-one" aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{getRouterValue();}}/ressources/fiches">fiches d'expériences</a></li>
       ...
       <script>
        ...
        @endif
        <form id="form"  class="mt-0" action="{{ route('fiches.update', $fiches->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <div class="row mb-4 layout-spacing layout-top-spacing">
                ...
                <div class="col-xxl-9 col-xl-12 col-lg-12 col-md-12 col-sm-12">
                    ...
                    <div class="widget-content widget-content-area blog-create-section">
                        ...
                        <div class="row mb-4">
                            <div class="col-sm-12">
                                <input type="text"  name="titre" value="{{ $fiches->titre }}" required class="form-control" id="Post-Title" placeholder="Titre">
                            </div>
                        </div>
                        <div class="row mb-4">
                            <div class="col-sm-12">
                                <input  type="number" name="numero" value="{{ $fiches->numero }}" required class="form-control" id="Post-Title" placeholder="Numero">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="input-group mb-3">
                                ...
                                <textarea name="description"  required class="form-control" id="exampleFormControlTextarea1" placeholder="Description" rows="10"> {{ $fiches->description }}</textarea>
                    ...
                    <div class="widget-content widget-content-area blog-create-section mt-4">
                        ...
                        <div class="row mb-4">
                            <div class="col-xxl-12 mb-4">
                                <input type="text" name="meta_title" value="{{ $fiches->meta_title }}" required class="form-control" id="post-meta-title" placeholder="Meta Title">
                            </div>
                            <div class="col-xxl-12">
                                <label for="post-meta-description">Meta Description</label>
                                <textarea name="meta_description"  required class="form-control" id="post-meta-description" cols="10" rows="5">{{ $fiches->meta_description }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xxl-12 mb-4">
                                <div class="switch form-switch-custom switch-inline form-switch-primary">
                                    ...
                                    {{ $fiches->active_commentaire ? 'checked' : '' }}>
                            ...
                            <div class="col-xxl-12 col-md-12 mb-4">
                                ...
                                <input id="category" name="category[]" value="{{ $fiches->categories->pluck('nom')->implode(',') }}" placeholder="Choisissez...">
                            </div>
                            ...
                            <div class="col-xxl-12 col-md-12 mb-4">
                                ...
                                <img width="100px" src="{{ asset('storage/'.$fiches->image) }}" alt="">
                            ...
                            <div class="col-xxl-12 col-md-12 mb-4">
                                ...
                                @if ($fiches->file_fr)
                                <a href="{{ asset('storage/'.$fiches->file_fr) }}" download> Télécharger le fichier</a>
                                @endif
                            </div>
                            ...
                            <div class="col-xxl-12 col-md-12 mb-4">
                                ...
                                @if ($fiches->file_an)
                                <a href="{{ asset('storage/'.$fiches->file_an) }}" download> Télécharger le fichier</a>
                                @endif
                            </div>
                            ...
                            <div class="col-xxl-12 col-md-12 mb-4">
                                ...
                                @if ($fiches->file_pr)
                                <a href="{{ asset('storage/'.$fiches->file_pr) }}" download> Télécharger le fichier</a>
                                @endif
                            </div>

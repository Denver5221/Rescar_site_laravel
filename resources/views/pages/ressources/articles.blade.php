<x-base-layout :scrollspy="false">
    ...
    <div class="page-meta">
        <nav class="breadcrumb-style-one" aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="">Articles, Mémoires de recherche</a></li>
            </ol>
        </nav>
    </div>
    ...
    <div class="row layout-top-spacing" id="cancel-row">
        ...
        <div class=" widget-content seperator-header text-center">
           <a href="{{getRouterValue();}}/ressources/articles/ajouter"> <button class="btn btn-success mb-2 me-8 btn-lg" >Ajouter un article</button></a>
        </div>
                    ...
                    <center><br>
                        <div class="row">
                            <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                <h4>Liste des Articles, Mémoires de recherche</h4>
                            </div>
                        </div>
                    </center>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <span><img width="50" src="{{ asset('storage/' . $article->image)}}" class="profile-img" alt="avatar"></span>
                                </td>
                                <td>{{ strtoupper(substr($article->titre, 0, 20)) }}</td>
                                ...
                                <td class="text-center">
                                    <button class="{{ $statusClass }} status-button" data-status-url="{{ route('articles.updateStatus', $article->id)  }}" data-current-status="{{ $article->status ? 'active' : 'inactive' }}">{{ $statusText }}</button>
                                </td>
                                <td class="text-center">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuLink1">
                                            <a class="dropdown-item" href="{{ url('ressources/articles-mémoires-recherche/'.$article->slug) }}">Voir</a>
                                            <a class="dropdown-item" href="{{ url(getRouterValue().'/ressources/articles/modifier/'.$article->slug) }}" >Modifier</a>
                                            <button class="delete-button dropdown-item widget-content warning confirm" data-delete-url="{{ route('articles.delete', $article->id) }}">Supprimer</button>
                                        </div>
                                    </div>
                                </td>
                            </tr>

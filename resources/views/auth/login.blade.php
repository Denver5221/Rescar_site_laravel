                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-12 mb-3">
                            ...
                            <h2>Se Connecter</h2>
                            <p>Enter votre email et mots de passe</p>
                        ...
                        <div class="col-sm-6 col-12">
                            <div class="  mb-3">
                             <a href="{{ route('password.request') }}" class="text-danger"> Mots de passe oublié</a>
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="mb-4">
                                <button class="btn btn-warning w-100" style="background: #ff9a40; f">Connection</button>
                            </div>
                        </div>
                        <br>
                        ...
                        <div class="col-12">
                            <div class="text-center">
                                <p class="mb-0">Vous n'avez pas de compte ? <a href="/register" class="text-warning"> Inscrivez Vous</a></p>
                            </div>
                        </div>
